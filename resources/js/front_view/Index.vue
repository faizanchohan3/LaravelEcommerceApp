...
<section class="slider-area position-relative">
    <div class="third-slider-active">
        <div class="third-slider-item third-slider-bg" style="background-image:url('front_assets/img/slider/third_slider_bg.jpg')">
            ...
            <div class="container custom-container-two">
                <div class="third-slider-wrap">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6">
                            <div class="third-slider-img">
                                <div class="img-shape" data-background="../assets/img/slider/third_slide_shape.png" data-animation-in="zoomIn"
                                    data-delay-in="1" data-duration-in="1.5"></div>
            ...
            <div class="container custom-container-two">
                <div class="third-slider-wrap">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6">
                            <div class="third-slider-img">
                                <div class="img-shape"style="background-image:url('front_assets/img/slider/third_slider_bg.jpg')" data-animation-in="zoomIn"
                                    data-delay-in="1" data-duration-in="1.5"></div>
...
<section class="shoes-banner-area">
    <div class="container">
        <div class="shoes-banner-active">
            <div class="shoes-banner-bg" style="background-image: url('front_assets/img/bg/shoes-banner_bg.jpg')">
                <div class="row">
                    <div class="col-12">
