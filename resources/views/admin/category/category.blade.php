    ...
    <div class="page-wrapper">
        <div class="page-content">
                                ...
                                @foreach ($data as $da)
                                    <tr>
                                        ...
                                        <td><button type="button"
                                            ...
                                            <button type="submit"
                                                onclick="deletedata('{{ $da->id }}','categories')"class="btn btn-danger  ">Danger</button>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
            ...
            <div class="col">
                ...
                <form id="formsubmit" action="{{ url('admin/addcategories') }}" method="POST"
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="border p-4 rounded">
                                        ...
                                        <div class="row mb-3">
                                            <label for="enter_text" class="col-sm-3 col-form-label">Parent Category</label>
...
@endsection
<script>
function savedata(id, parent_id, name, slug) {
        var checkid = 0;
        if (checkid != 0) {
            $('#select option[value="'+checkid+'"] ').show();
        }
        checkid = id;
        $('#enter_text').val(name);
        $('#enter_slug').val(slug);
        $('#select').val(parent_id);
