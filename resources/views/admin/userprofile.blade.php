            ...
            <div class="container">
                <div class="main-body">
                    <div class="row">
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="list-group list-group-flush">
                                        ...
                                        <li
                                            ...
                                            <span class="text-secondary">{{ Auth::user()->github }}</span>
                                        </li>
                                        <li
                                            class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                            <h6 class="mb-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                            ...
                                            <span class="text-secondary">{{ Auth::user()->fv_link }}</span>
                                        </li>
                                        <li
                                            class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                            <h6 class="mb-0"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                        ...
                        <div class="col-lg-8">
                            <div class="card">
                            <form id="formsubmit" action="{{url('/admin/saveprofilechanges')}}"  method="POST" enctype="multipart/form-data">
                                    @csrf
                                <div class="card-body">
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="text" name="mbile"  class="form-control" value="(320) 380-4539" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
