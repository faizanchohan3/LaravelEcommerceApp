...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="img/favicon.png">
        ...
        <link rel="stylesheet" href="{{asset('front_assets/css/jquery.mCustomScrollbar.min.css')}}">
        <link rel="stylesheet" href="{{asset('front_assets/css/bootstrap-datepicker.min.css')}}">
        ...
        <link rel="stylesheet" href="{{asset('front_assets/css/jarallax.css')}}">
